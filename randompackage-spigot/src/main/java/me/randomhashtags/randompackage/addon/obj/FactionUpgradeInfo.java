...
public class FactionUpgradeInfo {
    private FactionUpgrade type;
    private FactionUpgradeLevel level;
    public FactionUpgradeInfo(FactionUpgrade type, FactionUpgradeLevel level) {
        this.type = type;
        this.level = level;
    }
    public FactionUpgrade getType() { return type; }
    public FactionUpgradeLevel getLevel() { return level; }
    public void setLevel(FactionUpgradeLevel level) { this.level = level; }
}
