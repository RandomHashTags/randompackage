    ...
    public void execute(Event event, HashMap<Entity, String> recipientValues, HashMap<String, String> valueReplacements) {
        for(Entity e : recipientValues.keySet()) {
            ...
            if(v != null) {
                ...
                final String value = replaceValue(at ? values[1] : values[0], valueReplacements);
                final World w = e.getWorld();
                final Location l = at ? toLocation(replaceValue(values[0], valueReplacements)) : e.getLocation();
