...
public class CustomEnchantTimerEvent extends RPEventCancellable {
    private LinkedHashMap<ItemStack, LinkedHashMap<CustomEnchant, Integer>> enchants;
    public CustomEnchantTimerEvent(Player player, LinkedHashMap<ItemStack, LinkedHashMap<CustomEnchant, Integer>> enchants) {
        super(player);
        this.enchants = enchants;
    }
    public LinkedHashMap<ItemStack, LinkedHashMap<CustomEnchant, Integer>> getEnchants() { return enchants; }
}
