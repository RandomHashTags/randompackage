                        ...
                        if(o != null) {
                            ...
                            if(cl.endsWith("LEFT")) {
                                if(buy > 0.00) {
                                    ...
                                    cost -= dis;
                                    final ItemStack is = si.getPurchased().copy();
                                    ...
                                    item = is;
                                    item.setQuantity(is.getQuantity()*amountPurchased);
                                    ...
                                    replacements.put("{ITEM}", item.getType().getName());
                                ...
                                if(sell > 0.00) {
                                    final ItemStack A = si.getPurchased().copy();
                                    final Inventory inv = player.getInventory();
                                    String p = "messages.sell" + (!inv.containsAtLeast(A, 1) ? " incomplete" : "");
                                    final double price = si.sellPrice;
                                    int amountSold = cl.equals("RIGHT") ? A.getQuantity() : A.getMaxStackQuantity();
