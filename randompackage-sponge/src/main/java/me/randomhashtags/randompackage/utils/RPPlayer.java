...
public class RPPlayer {
    ...
    public void backup() {
        ...
        for(UUID u : cee) {
            ...
            if(l != null) {
                ...
                final Living summoner = l.getSummoner();
        ...
        for(int p : showcase.keySet()) {
            ...
            for(ItemStack i : showcase.get(p)) {
                if(i != null && !i.getType().equals(ItemTypes.AIR)) {
                    ...
                    if(i.hasItemMeta()) {
                        ...
                        if(m.hasEnchants()) {
                            String en = "VEnchants{";
                            final Map<EnchantmentType, Integer> enchants = m.getEnchants();
                            for(EnchantmentType e : enchants.keySet()) {
    ...
    public static HashMap<FactionUpgrade, Integer> getFactionUpgrades(Player player) {
